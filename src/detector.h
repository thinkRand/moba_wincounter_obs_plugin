...
void detector_get_template_info(void *handle, struct TemplateInfo *victory, struct TemplateInfo *defeat);
enum MatchResult detector_process_frame(void *handle, const uint8_t *y_plane, int width, int height, int stride,
